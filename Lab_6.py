...
class l():
    ...
    def equation(self, N, m):
        ...
        for i in range(N):
            ...
            for j in range(m):
                ylist1.append(round(
                    2.1 + 1.7 * xmatr[i][0] + 6.8 * xmatr[i][1] + 6.6 * xmatr[i][2] + 9.5 * xmatr[i][0] ** 2 + 1.0 *
                    xmatr[i][1] ** 2 + 3.9 * xmatr[i][2] ** 2 + 3.0 * xmatr[i][0] * xmatr[i][1] + 0.1 * xmatr[i][0] *
                    xmatr[i][2] + 4.5 * xmatr[i][1] * xmatr[i][2] + 1.8 * xmatr[i][0] * xmatr[i][1] * xmatr[i][
